...
unsigned int[] Derate_Owner_Array {
    DERATE_NONE,
    DERATE_IGBT_TEMP_LIMIT,
    DERATE_WINDING_TEMP_LIMIT,
    DERATE_SPEED_LIMIT,
    DERATE_VOLT_LIMIT,
    DERATE_I2T_FAST_LIMIT,
    DERATE_DIRECT_TORQ_LIMIT,
    DERATE_TERMINAL_VOLTAGE,
    DERATE_IGBT_JUNCT_TEMP,
    DERATE_I2T_SLOW_LIMIT,
    DERATE_PEAK_TORQ_CURVE,
    DERATE_USER_DEF_TORQ_CURVE,
    DERATE_MSTR_SPEED_TORQ_CURVE,
    DERATE_CURR_LIMIT_OVRLD,
    DERATE_CURR_LIMIT_AC_SUPPLY
};